  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower Your Business with FinMaster: Streamline Accounts, Monitor Expenses, and Unveil Future Financial Opportunities Today"
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower Your Business with FinMaster: Streamline Accounts, Monitor Expenses, and Unveil Future Financial Opportunities Today`}
            </Text>

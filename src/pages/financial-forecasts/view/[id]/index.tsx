...
import { getFinancialForecastById } from 'apiSdk/financial-forecasts';
...
function FinancialForecastViewPage() {
  ...
  return (
    <AppLayout>
      <Text as="h1" fontSize="2xl" fontWeight="bold">
        Financial Forecast Detail View
      </Text>
